<?php
include "incKakaopayCommon.php"; //상수값일세
include "lgcns_CNSpay.php";  //로깅과 암호화
...
$merchantTxnNum = date("YmdHis",time());
?>
...
<script type="text/javascript" src="<?php echo ($CNSPAY_WEB_SERVER_URL) ?>/js/dlp/lib/jquery/jquery-1.11.1.min.js" charset="urf-8"></script>
...
<script type="text/javascript">
	...
	*/
	...
	function getTxnId() {
		...
		document.payForm.action = "getTxnId.php";
	  ...
	  if (document.payForm.canHaveHTML) { // detect IE
		...
		document.payForm.action = "kakaopayLiteResult.php";
		document.payForm.acceptCharset = "utf-8";
	  if (document.payForm.canHaveHTML) { // detect IE
	      document.charset = payForm.acceptCharset;
	  }
...
<body>
		<form name="payForm" id="payForm" action="kakaopayLiteResult.php"  method="post" accept-charset = "">
        <!-- 결제 파라미터 목록 -->
