...
/* 기타 */
$siteDomain = "http://127.0.0.1/inicis/INIStdPaySample"; //가맹점 도메인 입력
                                        ...
                                        <td style="text-align:left;">
                                            <form id="SendPayForm_id" name="" method="POST">
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><b>returnUrl</b> :
                                                    <br/><input  style="width:100%;" name="returnUrl" value="<?=$siteDomain?>/INIStdPayReturn.php" >
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input  style="width:100%;" name="offerPeriod" value="2015010120170331" >
                                                    <br/><br/>
                                                    ...
                                                    <br/><input style="width:100%;" name="acceptmethod" value="HPP(1):no_receipt:va_receipt:vbanknoreg(0):vbank(20160711):below1000" >
                                                </div>
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input style="width:100%;" name="closeUrl" value="<?=$siteDomain?>/close.php" >
                                                    ...
                                                    <br/><input style="width:100%;" name="popupUrl" value="<?=$siteDomain?>/popup.php" >
